...
We optimize for the best moving average parameters using a "what-if" solver
...
and automatically backtests the the strategy on a portfolio of tech stocks and
searches for best performing underlying. We also optimize for the best model
parameters and produce extensive trading strategy performance metrics.

4. Automated Trading Strategy using Tick Data - AutoTradingMA-TickDataVersion.ipynb
===================================================================================
Fourth, we extend the Python automated trading strategy from (3) using an event driven
approach, which allows us to work with tick data. This makes it simpler to add stop-losses
and easier to work with real-time and live streaming data. In the Python notebook, we
...
strategy utilizing the data streaming and order management class, and demo how to add
stop losses to the strategy and how to manage trades with tick data.
